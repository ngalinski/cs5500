...
import Helpers.Json_reader;
import Helpers.Multipliers;
import Writers.SQL_helper;
import Writers.Stats_writer;
...
public class Supermarket {
    ...
    private Json_reader json_parameters = new Json_reader();
    ...
    public void creation(Integer month, Integer day, Integer year, Boolean weather) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        supermarket.creation(8, 3, 2020, false);
